...
Multiple alabsystems repos have adopted **self-verification** patterns - using their
...
|---------|---------|----------|----------|
| **ay** | Kani proofs for internals | 200 proofs across 22 files | - |
| **clean** | Self-verification Phase 4 | 7/8 core functions constructive | clean#371 |
| **ny** | Soundness provenance | Distinguishes proofs from heuristics | - |
| **trust-mc** | ay bindings verification | In progress | trust-mc#982, trust-mc#1111 |
...
| **L2** | Comprehensive coverage | ay (200 proofs) |
| **L3** | Full self-verification | clean Phase 4 goal |
...
- dashnews#216: clean Phase 4 progress
- ay#1158: trust-mc verification harnesses in ay
- clean#371: Self-verification tracking issue
