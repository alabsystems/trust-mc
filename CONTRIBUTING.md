...
Andrew Yates at <andrewyates.name@gmail.com>; do **NOT** open a public issue.
See [SECURITY.md](SECURITY.md) for the full disclosure process.

## Licensing

trust-mc is distributed under the terms of both the MIT license and the Apache License (Version 2.0).
