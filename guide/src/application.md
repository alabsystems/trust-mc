...
You may be interested in applying trust-mc if you're in this situation:
...
In this section, we explain [how trust-mc compares with other tools](./tool-comparison.md)
and suggest [where to start applying trust-mc in real code](./tutorial-real-code.md).
