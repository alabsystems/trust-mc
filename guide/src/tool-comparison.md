...
At present, trust-mc [does not support verifying concurrent code](./rust-feature-support.md).
...
The former is sound (like trust-mc), but the latter is more scalable to large problem spaces (like property testing).
