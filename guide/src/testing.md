...
Testing in trust-mc is carried out in multiple ways. There are at least
...
Testing](./regression-testing.md) if you're interested in trust-mc
development.

For MIR-to-SMT validation beyond hand-written tests, see
