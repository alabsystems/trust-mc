...
tools](./tool-comparison.md#comparison-with-other-tools), trust-mc is based on a
...
that requires modeling are system calls and I/O operations. In some cases, trust-mc
performs such encoding through overriding some of the definitions in the Rust
standard library.

The following table lists some of the symbols that trust-mc
