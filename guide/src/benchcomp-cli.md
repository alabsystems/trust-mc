...
```yaml
# Compare a range of trust-mc and CBMC benchmarks when
...
variants:
  variant_a:
    config:
      ...
      command_line: scripts/trust-mc-perf.sh
      env: {}
  ...
  variant_b:
    config:
      ...
      # forces trust-mc to use the cadical SAT solver
      env:
        TRUST_MC_SOLVER: cadical
