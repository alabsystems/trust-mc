...
3. Input/Output code.
trust-mc doesn't model I/O, so if your code depends on behavior like reading/writing to a file, you won't be able to prove anything.
...
Running trust-mc on this simple starting point will help figure out:
...
3. Whether trust-mc will support all the Rust features involved.
...
Once you've got something working, the next step is to prove more interesting properties than just what trust-mc covers by default.
...
## Examples of the use of trust-mc

On the [Kani blog](https://model-checking.github.io/kani-verifier-blog/), we've documented worked examples of applying trust-mc (originally developed for Kani):
