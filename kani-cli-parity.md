...
| `--version-authority` | no | yes | extra | trust-mc-only top-level flag: prints trust-mc SHA/dirty state plus matched declared/linked AY revisions; fails closed on malformed, dirty, or mismatched AY authority. |
