...
//! trust_mc implementation of function contracts.
//!
...
//! ```
//!
//! Once we are finished specifying our contract we can ask trust_mc to check it's
...
//! inputs, trust_mc will use the pre- and postconditions we have specified for that
...
//! ```
//!
//! The harness is checked like any other by running `cargo trust_mc` and can be
...
//! `result`.
//!
//! In addition trust_mc provides the [`modifies`](macro@modifies) attribute. This
...
//!
//! In trust_mc, function contracts are optional. As such a function with at least
...
//! provide a `modifies` attribute. Otherwise trust_mc will reject a contract on
//! this function.
//!
