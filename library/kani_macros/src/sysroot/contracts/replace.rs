...
impl<'a> ContractConditionsHandler<'a> {
    ...
    /// let arg_name = unsafe { kani::internal::untracked_deref(&arg_value) };
    /// // single result havoc
    ...
    /// function.
    pub(super) fn replace_closure(&self) -> TokenStream {
    ...
    pub(super) fn expand_replace(&self, closure: &mut Stmt) {
