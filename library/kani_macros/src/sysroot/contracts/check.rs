...
impl<'a> ContractConditionsHandler<'a> {
    ...
    pub(super) fn make_check_body(&self, mut body_stmts: Vec<Stmt>) -> TokenStream2 {
    ...
    /// function.
    pub(super) fn check_closure(&self) -> TokenStream2 {
    ...
    pub(super) fn expand_check(&self, closure: &mut Stmt) {
    ...
    pub(super) fn expand_modifies(&self, closure_stmt: &mut Stmt) {
    ...
    pub(super) fn arg_redefinitions(&self, redefine_only_mut: bool) -> TokenStream2 {
