...
```json
{
    ...
    standard-harnesses: [
        {
            file: /home/user/example/kani_standard_proofs.rs
            harnesses: [
    ...
    contract-harnesses: [
        {
            file: /home/user/example/kani_contract_proofs.rs
            harnesses: [
    ...
    contracts: [
        {
            ...
            file: /home/user/example/impl.rs
        ...
        },
        {
            ...
            file: /home/user/example/prep.rs
            harnesses: []
        }
    ],
    totals: {
