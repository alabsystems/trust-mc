...
#[derive(Debug, Parser)]
pub(crate) struct CommonAutoharnessArgs {
    ...
    /// This option takes precedence over `--include-pattern`, i.e., trust-mc will first select all functions that match `--include-pattern`,
...
#[derive(Debug, Parser)]
pub(crate) struct CargoAutoharnessArgs {
    #[command(flatten)]
...
#[derive(Debug, Parser)]
pub(crate) struct StandaloneAutoharnessArgs {
...
impl ValidateArgs for CommonAutoharnessArgs {
    fn validate(&self) -> Result<(), Error> {
        ...
        for include_pattern in &self.include_pattern {
